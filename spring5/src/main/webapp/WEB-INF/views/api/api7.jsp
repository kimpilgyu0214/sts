...
<body>
	<div class="form">
		...
		<input type="text" name="name1" class="name" placeholder="학생명 입력" /><br><br>
		...
		<input type="text" name="name2" class="name" placeholder="학생명 입력" /><br><br>
		...
		<input type="text" name="name3" class="name" placeholder="학생명 입력" /><br><br>
	...
	$(document).ready(function(){
		$("#btn1").click(function(){
			var student = {stdNumber:0, name:"?", age:0};
